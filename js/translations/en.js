export const enTranslations = {
    ...
    printNotice: 'Print the PDF at 100% scale or actual size, with fit to page turned off.',
    ...
    pdfPrintSection: 'PRINT SETTINGS:',
    pdfPrintInstructions: '- Use 100% scale or actual size, turn off fit to page, and keep the same paper size as the PDF.',
